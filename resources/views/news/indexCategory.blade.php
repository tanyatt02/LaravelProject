...
<div class="container-fluid pb-4 pt-4 paddding"> 
    ...
    <div class="col-md-8 animate-box" data-animate-effect="fadeInLeft">
                ...
                @forelse($newsList as $news)
                    <div class="row pb-4">
                        ...
                        <div class="col-md-7 animate-box">
                            <a href="single.html" class="fh5co_magna py-2"> <a href="{{route('news.show', ['news' => $news->id])}}">{{$news->title}}<br></a>
                            </a> {{  $news->created_at }} 
                ...
                @empty
                    <h2 style='font-family: Poppins, sans-serif;'>Нет новостей День сурка</h2>
                @endforelse
